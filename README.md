...
-----
👨‍💻 \> lots of `python` (`aiohttp`, `fastapi`, `pillow`, `opencv-python`, `numpy`, `pytest`, ...) <br>
📹 \> good chunk of `Audio/Video` related experience with [FFmpeg](https://en.wikipedia.org/wiki/FFmpeg)<br>
